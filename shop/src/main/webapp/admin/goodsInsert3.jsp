								...
								<div class="card-body">
									<form action="goodsInsertPro3.jsp" method="post" onsubmit="checkGoods3(event)">
										...
										<div class="mb-3">
											...
											<input type="text" name="gosize" id="gosize" class="form-control form-control-lg"/>
										</div>
										<div class="mb-3">
											<label class="form-label">색상</label>
											<input type="text" name="gocolor" id="gocolor" class="form-control form-control-lg"/>
										</div>
										<div class="mb-3">
											<label class="form-label">수량</label>
											<input type="text" name="gocount" id="gocount" class="form-control form-control-lg"/>
										</div>
